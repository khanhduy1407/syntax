...
import { INkdTheme, IThemeRegistration, ILanguageRegistration } from './types'
import { fetchTheme, toNkdTheme } from './loader'
...
export class Registry extends TextMateRegistry {
  ...
  private _resolvedThemes: Record<string, INkdTheme> = {}
  ...
  public getTheme(theme: Theme | INkdTheme | string) {
  ...
  public async loadTheme(theme: Theme | INkdTheme | string) {
    if (typeof theme === 'string') {
