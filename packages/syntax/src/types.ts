...
export interface Highlighter {
   ...
   */
  getTheme(theme?: IThemeRegistration): INkdTheme
...
export type IThemeRegistration = INkdTheme | StringLiteralUnion<Theme>

export interface INkdTheme extends IRawTheme {
  /**
