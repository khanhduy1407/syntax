...
const langDir = path.resolve(__dirname, '../../packages/syntax/languages')
const sampleDir = path.resolve(__dirname, '../../packages/syntax/samples')
const langPath = path.resolve(__dirname, '../../packages/syntax/src/languages.ts')
